...
\title{
		\usefont{OT1}{bch}{b}{n}
		\huge LING 3250 Final Project: Analyzing the Efficacy of a Small BERT Model for Part-of-Speech Tagging \\
}
...
A comprehensive discussion of NLTK's PerceptronTagger \cite{nltk_perceptron} and its comparison with the fine-tuned model is included in the Jupyter Notebook, but not in this report.
